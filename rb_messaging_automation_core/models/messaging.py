...
class MessagingMessage(models.Model):
    ...
    payload_json = fields.Text(groups="rb_messaging_automation_core.group_messaging_technical")
    _sql_constraints = [
...
class MessagingEvent(models.Model):
    ...
    external_id = fields.Char(required=True, index=True)
    payload_json = fields.Text(required=True, groups="rb_messaging_automation_core.group_messaging_technical")
